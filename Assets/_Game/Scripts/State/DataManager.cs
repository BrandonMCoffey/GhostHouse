...
public class DataManager : MonoBehaviour
{
    ...
    public bool settingsMouseMotivatedMovement { get; set; }
    public bool settingsControllerBorderMovement { get; set; }
    ...
    private void SetDefaultValues() {
        ...
        settingsMouseMotivatedMovement = false;
        settingsControllerBorderMovement = true;
    }
    ...
    public void ReadFile() {
        if (File.Exists(filePath)) {
            ...
            try {
                ...
                settingsMouseMotivatedMovement = saveData.settings.mouseMotivated;
                settingsControllerBorderMovement = saveData.settings.controllerBorder;
    ...
    public void WriteFile() {
        ...
        saveData.settings.mouseMotivated = settingsMouseMotivatedMovement;
        saveData.settings.controllerBorder = settingsControllerBorderMovement;
    ...
    public void SaveControlSettings(bool leftClick, bool useWASD, bool useArrows, bool clickDrag, int sensitivity, bool mouseMotivated, bool controllerBorder) {
        ...
        settingsMouseMotivatedMovement = mouseMotivated;
        settingsControllerBorderMovement = controllerBorder;
